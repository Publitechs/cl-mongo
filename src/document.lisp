...
(defun set-field-value (document slot new-value)
  (setf (gethash (to-field-name slot) (elements document)) new-value))

(defun get-field-value (document slot &optional default)
  (gethash (to-field-name slot) (elements document) default))
...
(defun unbound-field (document slot)
  (remhash (to-field-name slot) (elements document))
  (mark-as-changed))
